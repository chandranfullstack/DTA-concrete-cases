...
import ConcereteCaseDetail2 from "src/pages/ConcreteCaseDetail/ConcreteCaseDetail2";
...
const router = createBrowserRouter([
  ...
  {
    path:CONCRETECASE_ADMIN_DATA(),
    element:<ConcereteCaseDetail2/>
  }
]);
