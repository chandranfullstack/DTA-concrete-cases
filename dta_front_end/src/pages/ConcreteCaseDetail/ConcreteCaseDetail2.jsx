...
const ConcereteCaseDetail2 = ({ customData, onlyContent = false }) => {
        ...
        <AppLayout>
          ...
          <div className="cases-detail-body">
            ...
            <div style={{ marginTop: "2.5rem", marginBottom: "2.5rem" }}>
              <AppTitle3 text="What happened?" isBold />
              <AppText1
                text={dataToShow?.contnet1}
                isMultiLine
            ...
            <div style={{ marginBottom: "2.5rem" }}>
              <AppTitle3 text={dataToShow?.content_title2} isBold />
              <AppText1
                text={dataToShow?.content2}
                isMultiLine
            ...
            <div style={{ marginBottom: "2.5rem" }}>
              <AppTitle3 text={t(dataToShow?.content_title3)} isBold />

              <AppText1
                text={dataToShow?.content3}
                isMultiLine
                otherClassNames="font-family-regular"
              />
            </div>
...
export default ConcereteCaseDetail2;
