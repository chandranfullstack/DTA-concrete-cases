  ...
  componentDidMount() {
    ...
    const getData = async () => {
     ...
     const res1=res.data
      ...
      allQuestionGroupIdsAndQuestionIdsStore[res1.quiz.id] = [];
      allAvailableQuestionGroupsStore.push(res1.assessment_groups_data);
      res1?.Questions?.map((questionData) => {
      ...
      console.log(res1,"response one",res1.quiz.id)
      res1.data?.map((questionGroupData) => {
        console.log(questionGroupData,"question group data")
        allQuestionGroupIdsAndQuestionIdsStore[questionGroupData.quiz.id] = [];
      ...
      this.setState(
        {
          ...this.state,
          QuestionGroupAndData: res1.assessment_groups_data
,
  ...
  fetchAndSetCurrentQuestionDetails = () => {
    ...
    this.setState({
      ...this.state,
      currentSelectedOptions:
        globalQuestionAndOptionsSelected[currentQuestion!==undefined?currentQuestion.Question_id:0] || [],
      serverData: {
        ...this.serverData,
